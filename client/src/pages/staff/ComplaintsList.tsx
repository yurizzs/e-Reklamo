    ...
    <div className="space-y-6 pb-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Button
          ...
          className="self-start bg-blue-950 hover:bg-blue-900 text-white dark:bg-white dark:hover:bg-slate-100 dark:text-slate-950 border border-slate-950 dark:border-transparent font-extrabold shadow-sm md:self-auto"
        >
          Add Complaint
        </Button>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {statCards.map((card) => (
          <div
            key={card.label}
            className="rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-bg-light p-5 shadow-sm transition-colors duration-300"
          >
            ...
            <div className="mt-5 text-3xl font-black text-slate-900 dark:text-white">
      ...
      <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-bg-light p-4 shadow-sm transition-colors duration-300 lg:flex-row lg:items-end">
        <InputField
          label="Search"
              ...
              {isLoading ? (
                ...
                complaints.map((complaint) => (
                  <TableRow key={complaint.id} className="border-b border-slate-100 dark:border-white/5 last:border-0 hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors">
                    ...
                    <TableCell className="max-w-xs truncate font-semibold text-slate-800 dark:text-white">
                      {complaint.title}
                    </TableCell>
                    <TableCell>
                      <span
